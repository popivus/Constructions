...
namespace ConstructionObjects
{
    public partial class FormSector : Form
    {
        ...
        private void SearchGrid(string search)
        {
            ...
            {
                table.Rows.Add(sector.ID_Sector, sector.Area, sector.Address, counterparties.Where(c => c.ID_Counterparty == sector.ID_Counterparty).FirstOrDefault().Name, sector.Deleted);
            }
        ...
        private void deleteButton_Click(object sender, EventArgs e)
        {
            if (sectorsGrid.SelectedRows.Count != 0)
            {
                ...
                APIHelper.DELETE("Sectors", current, current.ID_Sector);
                RefreshGrid();
            }
        }
