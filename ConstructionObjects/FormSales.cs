...
namespace ConstructionObjects
{
    public partial class FormSales : Form
    {
        ...
        private void SearchGrid(string search)
        {
            ...
            {
                if (!contract.Deleted) table.Rows.Add(contract.ID_Sales_contract, contract.Number, contract.Sum, contract.Contract_date, counterparties.Where(c => c.ID_Counterparty == contract.ID_Counterparty).FirstOrDefault().Name);
            }
