...
namespace ConstructionsAPI.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(ConstructionsDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<User>> GetUser(string id)
        {
            ...
            var user = await _context.User.Where(u => u.Name == userData[0] && u.Password == userData[1] && !u.Deleted).FirstOrDefaultAsync();
